...
const CourseInfoCard: React.FC<Course> = ({
	...
	return (
		<View style={[styles.courseCard, { borderColor: colors.primary }]}>
			<FAB style={{backgroundColor: 'red', aspectRatio: 1, width: 50, alignSelf: 'flex-end', position: 'absolute', alignItems: 'center', justifyContent: 'center'}} icon='alpha-x' onPress={() => deleteCourse({"block": block, "lunch": lunch, "name": name, "roomNumber": roomNumber, "teacher": teacher, "term": term})}></FAB>
