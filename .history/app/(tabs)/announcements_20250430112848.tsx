...
export default function Announcements() {
  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      const { data, error } = await supabase
        .from("announcements")
        .select("*")
        .order("id", { ascending: false }); // Select all fields, adjust if needed
  ...
  useEffect(() => {
    //only used to be able to connect the async profile data function to load onto announcements
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        />
          <Dialog visible={addAnnouncementVisible} onDismiss={()=>setAddAnnouncementVisible(!addAnnouncementVisible)}>
            <Dialog.Actions>
