        ...
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    console.log(profile.error || "no error")
                    const created = new Date(item.created_at).toLocaleString('en-US', {weekday: 'short',  // Optional: displays the full weekday name
                        year: 'numeric',
                        month: 'numeric',
                        day: 'numeric',
                        hour: 'numeric',
                    ...
                    return (
                        <Card style={{backgroundColor: colors.background, marginBottom: 20, padding: 20, borderColor: colors.primary}}>
                            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flex: 2}}>
                                ...
                                <Text style={[styles.item, { color: colors.primary, flex: 1, textAlign: 'right'}]}>{item ? created : 'Loading...'}</Text>
                            </View>
                            <Text style={[styles.item, { color: colors.primary, marginBottom: 14}]}>{profile ? profile.full_name : 'Loading...'}</Text>
